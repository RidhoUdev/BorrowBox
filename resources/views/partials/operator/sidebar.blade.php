        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('operator.items.index') }}"
                   class="relative flex items-center px-3 py-2.5 rounded-lg transition duration-150 ease-in-out group
                          {{ request()->routeIs('operator.items*')
                             ? 'bg-cyan-50 text-cyan-900 font-semibold before:content-[\'\'] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-1 before:h-4/5 before:bg-cyan-500 before:rounded-full'
                             : 'text-gray-700 hover:bg-cyan-50 hover:text-cyan-800' }}">
                    <div class="flex gap-3 items-center">
                ...
                <a href="{{ route('operator.requests.index') }}"
                   class="relative flex items-center px-3 py-2.5 rounded-lg transition duration-150 ease-in-out group
                    ...
                    <div class="flex items-center gap-3">
                        <span class="iconify w-6 h-6 flex-shrink-0 text-black" data-icon="mingcute:send-plane-fill"></span>
                        Daftar Permintaan
                    </div>
                </a>
            </li>
             <li>
                <a href="{{ route('operator.borrower.history.index') }}"
                   class="relative flex items-center px-3 py-2.5 rounded-lg transition duration-150 ease-in-out group
                    ...
                    <div class="flex items-center gap-3">
                        <span class="iconify w-6 h-6 flex-shrink-0" data-icon="ic:baseline-assignment-ind"></span>
                        Daftar Peminjam
                    </div>
                </a>
            </li>
